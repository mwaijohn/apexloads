...
const TripCard = () => {
    return (
        <div className="border rounded shadow bg-[#272627] border-[#3a3a3a]">
            <h3 className="text-basefont-medium mb-2 bg-[#3a3a3b] px-4 py-1">TRIP</h3>
            <div className="px-4 pb-4 flex flex-row justify-between">
                <div className='flex-1'>
                    ...
                    <div className="mt-4 ml-2">
                        <h4 className="text-basefont-medium mb-2">EQUIPMENT</h4>
                ...
                <div className="ml-5 flex-shrink-0">
                    <button className="bg-[#272627] text-white font-bold text-sm rounded-full px-3 py-2 flex items-center hover:bg-red-600 transition-colors border border-gray-400">
